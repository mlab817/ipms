                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="has_row" class="col-form-label col-sm-3">Does the project have a Right of Way Acquisition (ROWA)
                                        component?</label>
                                    <div class="col-sm-9">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">{{ __("Infrastructure Cost by RefRegion") }} </h3>
                            </div>
                            <div class="card-body">
