                    ...
                    <div class="mb-8 mx-auto text-center">
                        <div class="d-inline-block border p-4 rounded-2">
                            ...
                            <ul class="d-inline-block list-style-none ml-3 lh-condensed-ultra" style="position: relative; top: 2px">
                                ...
                                <li class="d-inline-block mr-3">
                                    <a target="_blank" href="https://www.youtube.com/playlist?list=PL_So0K6vZBM_Fa-V9ghcGjBQ26JGFqKwL" title="PIPS on Youtube" class="text-gray-light-mktg" aria-label="PIPS on Youtube">
                                        <svg height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 234.67 165.33"><path d="M229.763 25.817c-2.699-10.162-10.65-18.165-20.748-20.881C190.716 0 117.333 0 117.333 0S43.951 0 25.651 4.936C15.553 7.652 7.6 15.655 4.903 25.817 0 44.236 0 82.667 0 82.667s0 38.429 4.903 56.85C7.6 149.68 15.553 157.681 25.65 160.4c18.3 4.934 91.682 4.934 91.682 4.934s73.383 0 91.682-4.934c10.098-2.718 18.049-10.72 20.748-20.882 4.904-18.421 4.904-56.85 4.904-56.85s0-38.431-4.904-56.85" fill="red"></path><path d="M93.333 117.559l61.333-34.89-61.333-34.894z" fill="#fff"></path></svg>
                                    </a>
                                </li>
                            </ul>
                        </div>
