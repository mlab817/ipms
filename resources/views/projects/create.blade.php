            ...
            <form action="{{ route('projects.store') }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           id="title" name="title" placeholder="PAP Title" value="{{ old('title') }}">
                            ...
                            <div class="form-group row">
                                <label for="has_subprojects" class="col-form-label col-sm-3 required">Does this PAP have
                                    subprojects/activities? </label>
                                <div class="col-sm-9">
                                    <div class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="has_subprojects" value="1"
                                               @if(old('has_subprojects') == 1) checked @endif>
                                        <label class="form-check-label">Yes</label>
                                    </div>
                                    <div class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="has_subprojects" value="0"
                                               @if(old('has_subprojects') == 0) checked @endif>
                                        <label class="form-check-label">No</label>
                                    </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="has_infra" value="1"
                                               @if(old('has_infra') == 1) checked @endif>
                                        <label class="form-check-label">Yes</label>
                                    </div>
                                    <div class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="has_infra" value="0"
                                               @if(old('has_infra') == 0) checked @endif>
                                        <label class="form-check-label">No</label>
                                    </div>
                            ...
                            <div class="form-group row">
                                <label for="bases" class="col-form-label col-sm-3 required">Implementation
                                    Bases </label>
                                <div class="col-sm-9">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label @error('bases') text-danger @enderror">
                                                <input type="checkbox"
                                                       ...
                                                       @if(in_array($option->id, old('bases') ?? [])) checked @endif>
                                                {{ $option->name }}
                                            </label>
                                        </div>
                                    @endforeach
                            ...
                            <div class="form-group row">
                                <label for="expected_outputs" class="col-form-label col-sm-3 required">Expected
                                    Outputs </label>
                                <div class="col-sm-9">
                                    <textarea rows="4" style="resize: none;"
                                              ...
                                              placeholder="Expected outputs should directly contribute to identified RM outcome statement/output">{{ old('expected_outputs') }}</textarea>
                            ...
                            <div class="form-group row">
                                <label for="total_project_cost" class="col-form-label col-sm-3 required">Total Project
                                    Cost (in absolute PhP) </label>
                                <!-- TODO: Replace with MoneyInput -->
                                <div class="col-sm-9">
                                    <input type="text"
                                           class="money form-control @error('total_project_cost') is-invalid @enderror"
                                           name="total_project_cost" value="{{ old('total_project_cost', 0) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    @foreach($ou_types as $type)
                                        <strong class="@error('operating_units') text-danger @enderror">{{ $type->name }}</strong>
                                        @foreach($type->operating_units as $option)
                                            <div class="form-check">
                                                <label class="form-check-label @error('operating_units') text-danger @enderror">
                                                    <input
                                                        class="form-check-input"
                                                        type="checkbox" name="operating_units[]"
                                                        value="{{ $option->id }}" {{ in_array($option->id, old('operating_units') ?? []) ? 'checked' : '' }}>
                                                    {{ $option->name }}
                                                </label>
                                            </div>
                                        @endforeach
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="research" value="1"
                                                   @if(old('research') == 1) checked @endif>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="research" value="0"
                                                   @if(old('research') == 0) checked @endif>
                                            No
                                        </label>
                                    </div>
                                    @error('research')<span
                            ...
                            <div class="form-group row">
                                <label for="covid_interventions" class="col-form-label col-sm-3">Included in which of
                                    the following document: </label>
                                <div class="col-sm-9">
                                    @foreach($covidInterventions as $option)
                                        <div class="form-check">
                                            <label class="form-check-label" for="covid_{{ $option->id }}">
                                                <input id="covid_{{ $option->id }}" type="checkbox"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    ...
                                    <p>
                                        <button type="button" id="selectRegions" class="btn btn-sm btn-secondary">Check
                                            All
                                        </button>
                                        <button type="button" id="clearRegions" class="btn btn-sm btn-danger">Clear
                                        </button>
                                    </p>
                                </div>
                                <div class="col-sm-9">
                                        ...
                                        @if($option->id !== 99)
                                            <div class="form-check">
                                                <label class="form-check-label @error('regions') text-danger @enderror">
                                                    <input class="regions-checkboxes form-check-input" type="checkbox"
                                                           name="regions[]"
                                                           value="{{ $option->id }}" {{ in_array($option->id, old('regions') ?? []) ? 'checked' : '' }}>
                                                    {{ $option->name }}
                                                </label>
                                            </div>
                                        @endif
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <select
                                                ...
                                                @foreach($years as $option)
                                                    <option
                                                        value="{{ $option }}" {{ old('target_start_year') == $option ? 'selected' : '' }}>{{ $option }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="target_end_year" class="col-form-label col-sm-3 required">Year of
                                            Project Completion </label>
                                        <div class="col-sm-9">
                                            <select class="form-control @error('target_end_year') is-invalid @enderror"
                                                ...
                                                @foreach($years as $option)
                                                    <option
                                                        value="{{ $option }}" {{ old('target_end_year') == $option ? 'selected' : '' }}>{{ $option }}</option>
                                                @endforeach
                                            </select>
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="iccable" class="col-form-label col-sm-3 required">Is the Project
                                    ICC-able? </label>
                                <div class="col-sm-9">
                                    <div class="form-check-inline">
                                        <input type="radio" class="form-check-input" value="1"
                                               name="iccable" {{ old('iccable') == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label">Yes</label>
                                    </div>
                                    <div class="form-check-inline">
                                        <input type="radio" class="form-check-input" value="0"
                                               name="iccable" {{ old('iccable') == 0 ? 'checked' : '' }}>
                                        <label class="form-check-label">No</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="approval_date" class="col-form-label col-sm-3">Date of
                                    Submission/Endorsement/Approval</label>
                                <div class="col-sm-9">
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3 required" for="rdip">Regional Development
                                    Investment Program </label>
                                <div class="col-sm-9">
                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="rdip_1">
                                            <input class="form-check-input" type="radio" id="rdip_1" name="rdip"
                                                   value="1" @if(old('rdip') == 1) checked @endif>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label" for="rdip_0">
                                            <input class="form-check-input" type="radio" id="rdip_0" name="rdip"
                                                   value="0" @if(old('rdip') == 0) checked @endif>
                                            No
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3" for="rdc_endorsement_required">Is RDC endorsement
                                    required? </label>
                                <div class="col-sm-9">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="rdc_endorsement_required"
                                                   value="1" @if(old('rdc_endorsement_required') == 1) checked @endif>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="rdc_endorsement_required"
                                                   value="0" @if(old('rdc_endorsement_required') == 0) checked @endif>
                                            No
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3" for="rdc_endorsed">Has the project been
                                    endorsed?</label>
                                <div class="col-sm-9">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="rdc_endorsed" value="1"
                                                   @if(old('rdc_endorsed') == 1) checked @endif>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="rdc_endorsed" value="0"
                                                   @if(old('rdc_endorsed') == 0) checked @endif>
                                            No
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3" for="rdc_endorsed_date">RDC Endorsement
                                    Date</label>
                                <div class="col-sm-9">
                                    <input type="date"
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="iccable" class="col-form-label col-sm-3">Does the conduct of feasibility
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" value="1"
                                                   ...
                                                   @if(old('feasibility_study[need_assistance]') == 1) checked @endif>
                                            Yes
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" value="0"
                                                   name="feasibility_study[needs_assistance]"
                                                   @if(old('feasibility_study[need_assistance]') == 0) checked @endif>
                                            No
                                        </label>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" class="money fs form-control text-right"
                                                       ...
                                                       value="{{ old('feasibility_study.y2017', 0) }}">
                                            </td>
                                            <td>
                                                <input type="text" class="money fs form-control text-right"
                                                       name="feasibility_study[y2018]"
                                                       value="{{ old('feasibility_study.y2018', 0) }}">
                                            </td>
                                            <td>
                                                <input type="text" class="money fs form-control text-right"
                                                       name="feasibility_study[y2019]"
                                                       value="{{ old('feasibility_study.y2019', 0) }}">
                                            </td>
                                            <td>
                                                <input type="text" class="money fs form-control text-right"
                                                       name="feasibility_study[y2020]"
                                                       value="{{ old('feasibility_study.y2020', 0) }}">
                                            </td>
                                            <td>
                                                <input type="text" class="money fs form-control text-right"
                                                       name="feasibility_study[y2021]"
                                                       value="{{ old('feasibility_study.y2021', 0) }}">
                                            </td>
                                            <td>
                                                <input type="text" class="money fs form-control text-right"
                                                       name="feasibility_study[y2022]"
                                                       value="{{ old('feasibility_study.y2022', 0) }}">
                                            </td>
                                            <td>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" name="feasibility_study[completion_date]"
                                           value="{{ old('feasibility_study.completion_date') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="employment_generated" class="col-form-label col-sm-3 required">No. of
                                    persons to be employed after completion of the project</label>
                                <div class="col-sm-9">
                                    <input class="form-control @error('employment_generated') is-invalid @enderror"
                                           type="number" name="employment_generated"
                                           value="{{ old('employment_generated') }}"
                                           placeholder="Indicate the no. of persons to be employed by the project outside of the implementing agency only">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label @error('pdp_chapter_id') text-danger @enderror" for="pdp_chapter_{{ $option->id }}">
                                                <input id="pdp_chapter_{{ $option->id }}" type="checkbox"
                                                       value="{{ $option->id }}" class="form-check-input"
                                                       name="pdp_chapters[]"
                                                       @if(in_array($option->id, old('pdp_chapters') ?? [])) checked @endif>
                                                {{ $option->name }}
                                            </label>
                                        </div>
                                    @endforeach
                                ...
                                @foreach ($pdp_indicators as $pi1)
                                    <div id="pdp_chapter_{{$pi1->id}}" class="pdp_chapters" style="display: none;">
                                        ...
                                        @foreach($pi1->children as $pi2)
                                            <div class="ml-4">
                                                <div class="form-check">
                                                    <label class="col form-check-label" for="pdp_outcome_{{$pi2->id}}">
                                                        <input type="checkbox" class="form-check-input pdp_indicators"
                                                               id="pdp_outcome_{{$pi2->id}}" value="{{$pi2->id}}"
                                                               name="pdp_indicators[]"
                                                               @if(in_array($pi2->id, old('pdp_indicators') ?? [])) checked @endif>
                                                        {{ $pi2->name }}
                                                    </label>
                                                </div>
                                                <div>
                                                            ...
                                                            <div class="form-check">
                                                                <label class="col form-check-label"
                                                                    ...
                                                                    <input type="checkbox"
                                                                           ...
                                                                           value="{{$pi3->id}}" name="pdp_indicators[]"
                                                                           @if(in_array($pi3->id, old('pdp_indicators') ?? [])) checked @endif>
                                                                    {{ $pi3->name }}
                                                                </label>
                                                            </div>
                                                                    ...
                                                                    <div class="form-check">
                                                                        <label class="col form-check-label"
                                                                            ...
                                                                            <input type="checkbox"
                                                                                   ...
                                                                                   value="{{$pi4->id}}"
                                                                                   name="pdp_indicators[]"
                                                                                   @if(in_array($pi4->id, old('pdp_indicators') ?? [])) checked @endif>
                                                                            {{ $pi4->name }}
                                                                        </label>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label" for="sdg_{{ $option->id }}">
                                                <input id="sdg_{{ $option->id }}" type="checkbox"
                                                       value="{{ $option->id }}" class="form-check-input" name="sdgs[]">
                                                {{ $option->name }}
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control @error('updates_date') is-invalid @enderror"
                                           id="updates_date" name="updates_date" value="{{ old('updates_date') }}">
                            ...
                            <table class="table table-responsive table-sm">
                                ...
                                @foreach ($funding_sources as $fs)
                                    <tr>
                                        ...
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2016 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2016]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2016", 0) }}"></td>
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2017 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2017]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2017", 0) }}"></td>
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2018 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2018]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2018", 0) }}"></td>
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2019 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2019]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2019", 0) }}"></td>
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2020 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2020]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2020", 0) }}"></td>
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2021 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2021]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2021", 0) }}"></td>
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2022 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2022]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2022", 0) }}"></td>
                                        <td><input type="text"
                                                   class="fs_investments fs_investments_2023 fs_investments_{{$fs->id}} money form-control text-right"
                                                   name="fs_investments[{{$fs->id}}][y2023]"
                                                   value="{{ old("fs_investments.{$fs->id}.y2023", 0) }}"></td>
                                        <td><input type="text" class="form-control text-right"
                                                   id="fs_investments_{{$fs->id}}_total" readonly></td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
                                ...
                                @foreach ($regions->sortBy('order') as $fs)
                                    ...
                                    @if($fs->id !== 100)
                                        <tr>
                                            ...
                                            <td><input type="text"
                                                       class="region_investments region_investments_2016 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2016]"
                                                       value="{{ old("region_investments.{$fs->id}.y2016", 0) }}"></td>
                                            <td><input type="text"
                                                       class="region_investments region_investments_2017 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2017]"
                                                       value="{{ old("region_investments.{$fs->id}.y2017", 0) }}"></td>
                                            <td><input type="text"
                                                       class="region_investments region_investments_2018 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2018]"
                                                       value="{{ old("region_investments.{$fs->id}.y2018", 0) }}"></td>
                                            <td><input type="text"
                                                       class="region_investments region_investments_2019 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2019]"
                                                       value="{{ old("region_investments.{$fs->id}.y2019", 0) }}"></td>
                                            <td><input type="text"
                                                       class="region_investments region_investments_2020 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2020]"
                                                       value="{{ old("region_investments.{$fs->id}.y2020", 0) }}"></td>
                                            <td><input type="text"
                                                       class="region_investments region_investments_2021 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2021]"
                                                       value="{{ old("region_investments.{$fs->id}.y2021", 0) }}"></td>
                                            <td><input type="text"
                                                       class="region_investments region_investments_2022 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2022]"
                                                       value="{{ old("region_investments.{$fs->id}.y2022", 0) }}"></td>
                                            <td><input type="text"
                                                       class="region_investments region_investments_2023 region_investments_{{$fs->id}} form-control money text-right"
                                                       name="region_investments[{{$fs->id}}][y2023]"
                                                       value="{{ old("region_investments.{$fs->id}.y2023", 0) }}"></td>
                                            <td><input type="text" class="form-control money text-right"
                                                       id="region_investments_{{$fs->id}}_total" readonly></td>
                                        </tr>
                                    @endif
                                @endforeach
                                </tbody>
                        ...
                        <div class="card-body p-0">
                            <table class="table table-responsive table-sm">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="nep money form-control text-right" name="nep[y2016]"
                                               value="{{ old("nep.y2016", 0) }}"></td>
                                    <td><input type="text" class="nep money form-control text-right" name="nep[y2017]"
                                               value="{{ old("nep.y2017", 0) }}"></td>
                                    <td><input type="text" class="nep money form-control text-right" name="nep[y2018]"
                                               value="{{ old("nep.y2018", 0) }}"></td>
                                    <td><input type="text" class="nep money form-control text-right" name="nep[y2019]"
                                               value="{{ old("nep.y2019", 0) }}"></td>
                                    <td><input type="text" class="nep money form-control text-right" name="nep[y2020]"
                                               value="{{ old("nep.y2020", 0) }}"></td>
                                    <td><input type="text" class="nep money form-control text-right" name="nep[y2021]"
                                               value="{{ old("nep.y2021", 0) }}"></td>
                                    <td><input type="text" class="nep money form-control text-right" name="nep[y2022]"
                                               value="{{ old("nep.y2022", 0) }}"></td>
                                    <td><input readonly type="text" class="nep money form-control text-right"
                                               name="nep[y2023]" value="{{ old("nep.y2023", 0) }}"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="allocation money form-control text-right"
                                               name="allocation[y2016]" value="{{ old("allocation.y2016", 0) }}"></td>
                                    <td><input type="text" class="allocation money form-control text-right"
                                               name="allocation[y2017]" value="{{ old("allocation.y2017", 0) }}"></td>
                                    <td><input type="text" class="allocation money form-control text-right"
                                               name="allocation[y2018]" value="{{ old("allocation.y2018", 0) }}"></td>
                                    <td><input type="text" class="allocation money form-control text-right"
                                               name="allocation[y2019]" value="{{ old("allocation.y2019", 0) }}"></td>
                                    <td><input type="text" class="allocation money form-control text-right"
                                               name="allocation[y2020]" value="{{ old("allocation.y2020", 0) }}"></td>
                                    <td><input type="text" class="allocation money form-control text-right"
                                               name="allocation[y2021]" value="{{ old("allocation.y2021", 0) }}"></td>
                                    <td><input readonly type="text" class="allocation money form-control text-right"
                                               name="allocation[y2022]" value="{{ old("allocation.y2022", 0) }}"></td>
                                    <td><input readonly type="text" class="allocation money form-control text-right"
                                               name="allocation[y2023]" value="{{ old("allocation.y2023", 0) }}"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2016]" value="{{ old("disbursement.y2016", 0) }}">
                                    </td>
                                    <td><input type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2017]" value="{{ old("disbursement.y2017", 0) }}">
                                    </td>
                                    <td><input type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2018]" value="{{ old("disbursement.y2018", 0) }}">
                                    </td>
                                    <td><input type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2019]" value="{{ old("disbursement.y2019", 0) }}">
                                    </td>
                                    <td><input type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2020]" value="{{ old("disbursement.y2020", 0) }}">
                                    </td>
                                    <td><input type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2021]" value="{{ old("disbursement.y2021", 0) }}">
                                    </td>
                                    <td><input readonly type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2022]" value="{{ old("disbursement.y2022", 0) }}">
                                    </td>
                                    <td><input readonly type="text" class="disbursement money form-control text-right"
                                               name="disbursement[y2023]" value="{{ old("disbursement.y2023", 0) }}">
                                    </td>
                                    <td><input type="text" class="form-control text-right" id="disbursement_total"
                                               readonly></td>
                                </tr>
                                </tbody>
                            </table>
