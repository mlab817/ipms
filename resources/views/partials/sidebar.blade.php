...
{{--                @endcan--}}
                ...
                @can('exports.view_index')
                    <li class="nav-item">
                        <a href="{{ route('exports.index') }}" class="nav-link @if(Route::current()->getName() == 'exports.index') active @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon" viewBox="0 0 20 20" fill="currentColor">
                ...
                <li class="nav-item">
                    <a href="{{ route('links.index') }}" class="nav-link @if(Route::current()->getName() == 'links.index') active @endif">
                        <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon" viewBox="0 0 20 20" fill="currentColor">
                ...
                @can('audit_logs.view_index')
                    <li class="nav-item">
                        <a href="{{ route('audit_logs.index') }}" class="nav-link @if(Route::current()->getName() == 'audit_logs.index') active @endif">
                            <svg xmlns="http://www.w3.org/2000/svg" class="sidebar-icon" viewBox="0 0 20 20" fill="currentColor">
