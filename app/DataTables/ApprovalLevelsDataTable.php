...
class ApprovalLevelsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($approvalLevel) {
                return '
                    <a href="' . route('admin.approval_levels.edit', $approvalLevel->slug) .'" class="btn btn-info btn-sm">Edit</a>
                ';
            });
    }
     ...
     *
     * @param \App\Models\RefApprovalLevel $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(RefApprovalLevel $model)
    {
