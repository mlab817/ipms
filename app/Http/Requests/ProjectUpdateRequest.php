...
class ProjectUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'approval_date'                     => 'required_if:iccable,1|date',
            'ref_gad_id'                        => 'required_if:iccable,1|exists:ref_gads,id',
            'rdip'                              => 'required|bool',
            ...
            'nep.*'                             => 'required_if:ref_project_status_id,2',
            ...
            'allocation.*'                      => 'required_if:ref_project_status_id,2',
            ...
            'disbursement.*'                        => 'required_if:ref_project_status_id,2',
