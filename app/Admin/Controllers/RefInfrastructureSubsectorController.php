...
class RefInfrastructureSubsectorController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'RefInfrastructureSubsector';
    ...
    {
        $grid = new Grid(new RefInfrastructureSubsector());
    ...
    {
        $show = new Show(RefInfrastructureSubsector::findOrFail($id));
    ...
    {
        $form = new Form(new RefInfrastructureSubsector());
