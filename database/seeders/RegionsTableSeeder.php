    ...
    public function run()
    {
        $seeds = [
            ...
            [
                ...
                'label'         => 'RefRegion IV-A',
                'order'         => 6,
            ],
            [
                'id'            => 5,
                'name'          => 'Bicol RefRegion',
            ...
            [
                'id'            => 15,
                'name'          => 'Cordillera Administrative RefRegion',
            ...
            [
                'id'            => 14,
                'name'          => 'Autonomous RefRegion in Muslim Mindanao',
