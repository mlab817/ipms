...
class OperatingUnitsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $seeds = [
            ...
            ['name'=>'RFO CAR - Cordillera Administrative RefRegion', 'operating_unit_type_id' => 3, 'label' => 'RFO CAR' ],
            ['name'=>'RFO I - Ilocos RefRegion', 'operating_unit_type_id' => 3, 'label' => 'RFO I' ],
            ...
            ['name'=>'RFO V - Bicol RefRegion', 'operating_unit_type_id' => 3, 'label' => 'RFO V' ],
            ...
            ['name'=>'RFO XI - Davao RefRegion', 'operating_unit_type_id' => 3, 'label' => 'RFO XI' ],
